                        ...
                        <div className="row footer_main_area">
                            ...
                            <div className="footer_children tnc">
                                <a href="https://workerb.io/terms_and_conditions.html"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_term&cond', action: 'click', label: 'footer_link_click' })
                                        logEvent('docs_click_footer_term&cond')
                                    }}>
                                    Terms &amp; Condition</a>
                                <a href="https://workerb.io/privacy_policy.html"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_privacypol', action: 'click', label: 'footer_link_click' })
                            ...
                            <div className="footer_children social_icons">
                                <a href="https://github.com/workerb-io/" target="_blank" rel="noopener noreferrer"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_github', action: 'click', label: 'footer_link_click' })
                                ...
                                <a href="https://www.linkedin.com/company/workerb/" target="_blank" rel="noopener noreferrer"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_linkedin', action: 'click', label: 'footer_link_click' })
                                ...
                                <a href="https://www.youtube.com/channel/UCguq9sXrm-B3eF7xqRAPnzA" target="_blank" rel="noopener noreferrer"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_youtube', action: 'click', label: 'footer_link_click' })
                                ...
                                <a href="https://twitter.com/workerb_io" target="_blank" rel="noopener noreferrer"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_twitter', action: 'click', label: 'footer_link_click' })
                                ...
                                <a href="https://medium.com/workerb" target="_blank" rel="noopener noreferrer"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_medium', action: 'click', label: 'footer_link_click' })
                                ...
                                <a href="https://spectrum.chat/workerb" target="_blank" rel="noopener noreferrer"
                                    onClick={() => {
                                        ReactGA.event({ category: 'docs_click_footer_spectrum', action: 'click', label: 'footer_link_click' })
